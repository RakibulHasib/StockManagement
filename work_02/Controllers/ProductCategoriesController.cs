...
namespace work_02.Controllers
{
    public class ProductCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductCategoryID,ProductName")] ProductCategory productCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductCategoryID,ProductName")] ProductCategory productCategory)
        {
            if (ModelState.IsValid)
            {
